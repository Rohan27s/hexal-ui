        ...
        <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="flex justify-center mb-12 relative">
                <div className="inline-flex items-center relative p-1 bg-gray-800 rounded-full shadow-lg overflow-hidden">
                    ...
                    {['monthly', 'yearly'].map(function (cycle) {
                        return (<button key={cycle} onClick={function () { return handleBillingChange(cycle); }} className={"px-6 py-2 z-10 font-medium text-lg relative rounded-full transition-all duration-300 focus:outline-none ".concat(billingCycle === cycle ? 'text-white' : 'text-gray-300')} style={{ minWidth: '130px' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                {plans.map(function (plan, index) {
                    return (<div key={index} className={"relative p-8 bg-white/10 backdrop-blur-lg rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:scale-105 border border-transparent ".concat(plan.borderColor)}>
