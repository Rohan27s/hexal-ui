        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4, expect(loginButton).toBeInTheDocument()];
                case 1:
                    _c.sent();
                    return [4, userEvent.click(loginButton)];
                case 2:
                    _c.sent();
                    return [4, expect(loginButton).not.toBeInTheDocument()];
                case 3:
                    _c.sent();
                    logoutButton = canvas.getByRole('button', { name: /Log out/i });
                    return [4, expect(logoutButton).toBeInTheDocument()];
                case 4:
                    _c.sent();
                    return [2];
            }
