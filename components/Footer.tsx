...
import { FaGithub, FaEnvelope, FaDollarSign, FaBook } from 'react-icons/fa'; // Import icons
...
const Footer = () => {
    ...
    return (
        <footer className="relative bg-gray-900 text-white py-16 px-4 text-center overflow-hidden">
